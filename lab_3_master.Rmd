...
Childhood BLL is positively correlated with crime rate and positively correlated with density. The coefficient on `density` is 0.115702, so the bias is positive away from zero.
