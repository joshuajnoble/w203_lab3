...
```{r}
density_table <- data.frame(data_crmrte[data_crmrte$crmrte > 0.07,]$county, data_crmrte[data_crmrte$crmrte > 0.07,]$crmrte, data_crmrte[data_crmrte$crmrte > 0.07,]$density)
kable(density_table, col.names = c("County", "Crime Rate", "Density"), caption = "Density and Outliers")
```
...
```{r}
density_table <- data.frame(data_crmrte[data_crmrte$crmrte < 0.01,]$county, data_crmrte[data_crmrte$crmrte < 0.01,]$crmrte, data_crmrte[data_crmrte$crmrte < 0.01,]$density)
kable(density_table, col.names = c("County", "Crime Rate", "Density"), caption = "Density and Outliers")
