...
While an increase in police presence predicts an increase in crime rates, it should be noted that this does not indicate that additional police cause an increase in crime. The results suggest that with additional police there will be an initial increase in apprehension of criminals, resulting in an increase in police reports. The actual reduction in committed crimes due to a larger police presence may see a lag effect. In addition, police presence and crime rate may be violating simultaneity bias, which states that the dependent and indepedent variable influence each other at the same time. While this issue is worth reviewing further, it is outside the scope of this report. 
