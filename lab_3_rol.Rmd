...
#prbconv was defined as factor data type , we convert it to numeric
...
2. The average of density for the outlier is 3X the average density for the sample
3. Esp data ppt 53 which has the highest crime rate and is Urban

This is not very surprising as Urban areas with high density of population tend to have more crime.

we will conisder the treatment of these outlier in later part of the report.
```{r}
...
__CLM assumptions analysis__
1. The residuals vs. fitted plot indicates that the zero conditional mean assumpotion is violated and the thickness indicates possible hetroskedasticity. 
2. The Q-Q plot shows that the residuals are normally distributed.
3. The scale location plot clearly shows the presence of hetroskedasticity especially on the LHS.
4.The residuals vs leverage plot shows some of the outliers but that there are no significantly influential outliers ( having high leverage and Cook's distance >1).\
